...
class UrlTest(unittest.TestCase):
    @parameterized.expand(['http:www.example.com/main.html', 'foobar', '//foo.com', 'www.google.com'])
    ...
    def test_if_it_not_raise_an_exception_when_address_is_valid(self, address: str) -> None:
