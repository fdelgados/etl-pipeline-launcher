from corpus_builder.build.domain.model.build import BuildId, BuildStatus, BuildRepository
...
class BuildStatusChecker:
    def __init__(self, build_repository: BuildRepository, requests_counter: RequestsCounter):
