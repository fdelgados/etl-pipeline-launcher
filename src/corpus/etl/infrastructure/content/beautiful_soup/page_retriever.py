...
class PageRetrieverImpl(PageRetriever):
    ...
    def retrieve(self, url: Url, etl: Etl) -> Page:
        ...
        headers = self._request_headers(etl.request_headers)
        try:
            ...
            blacklisted_tags = etl.excluded_tags
            blacklisted_tags.extend(self._DEFAULT_BLACKLISTED_TAGS)
            body = markup_parser.body(blacklisted_tags, etl.excluded_selectors)

            selector_mapping = etl.selector_mapping or {}
