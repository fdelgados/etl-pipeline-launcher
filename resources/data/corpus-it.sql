CREATE USER 'corpus_it'@'%' IDENTIFIED BY 'xaAbtE4k2S6Q';

CREATE DATABASE corpus_it CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

GRANT INSERT, SELECT, UPDATE, DELETE ON corpus_it.* TO 'corpus_it';
