CREATE DATABASE IF NOT EXISTS corpus_builder CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER 'corpus_builder'@'%' IDENTIFIED BY 'wTUbtEmk2S6R';

GRANT INSERT, SELECT, UPDATE, DELETE ON corpus_builder.* TO 'corpus_builder';
